...
_MESSAGES: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "add.title": "添加账号",
        "add.desc": "在浏览器里完成一次官方登录即可。不会影响当前登录的账号。",
        "add.ed_cn": "国内版（copilot.tencent.com）",
        "add.ed_intl": "国际版（www.workbuddy.ai）",
        "add.start": "开始登录",
        "add.logging": "正在添加账号（{ed}）…",
        "add.open_url": "已在浏览器打开登录页；若没有，请手动打开：",
        "add.waiting": "  等待授权完成… {sec}s",
        "login.edition": "账号版本：{ed}",
        "login.start_failed": "获取授权链接失败：{err}",
        "login.open_url": "在浏览器里打开下面的链接完成登录：",
        "login.browser_opened": "已尝试自动打开浏览器。",
        "login.waiting": "等待授权完成（最多 {sec} 秒）…",
        "login.failed": "登录失败：{err}",
        "login.save_failed": "登录成功但建档失败：{err}",
        "login.ok": "已添加账号「{name}」",
        "login.hint": "之后可以直接用 switch 切到它，无需重新登录。",
        "sess.adopt_note": "注意：云端归属已一并调整。若客户端正在运行，归属映射可能需退出客户端后才生效。",
        "body.title": "会话正文归档",
        "body.dir": "归档目录",
        "body.blobs": "正文文件",
        "body.size": "占用空间",
        "body.session": "已知会话",
        "body.withbody": "其中有正文",
        "body.missing_hint": "{n} 条会话缺正文，可执行 bodies --archive 收录（需正文仍在磁盘上）。",
        "body.archiving": "正在收录 {n} 条会话的正文…",
        "body.archived": "收录完成：新存 {stored} 份、去重 {deduped} 份、缺失 {missing} 条，新增 {size}",
        "body.restored": "已还原正文：{path}",
        "body.not_found": "归档里没有会话 {sid} 的正文",
    ...
    "en": {
        ...
        # login / session assets
        "login.title": "Sign in a new account",
        "btn.add_account": "Add account",
        "add.title": "Add account",
        "add.desc": "Complete one official sign-in in your browser. Your current login is untouched.",
        "add.ed_cn": "CN (copilot.tencent.com)",
        "add.ed_intl": "Intl (www.workbuddy.ai)",
        "add.start": "Start",
        "add.logging": "Adding account ({ed})…",
        "add.open_url": "Opened the sign-in page in your browser; if not, open this URL manually:",
        "add.waiting": "  waiting for authorization… {sec}s",
        "login.edition": "Edition: {ed}",
        "login.start_failed": "Failed to get authorization URL: {err}",
        "login.open_url": "Open this URL in your browser to sign in:",
        "login.browser_opened": "Tried to open your browser.",
        "login.waiting": "Waiting for authorization (up to {sec}s)…",
        "login.failed": "Login failed: {err}",
        "login.save_failed": "Signed in but failed to save profile: {err}",
        "login.ok": "Account added: “{name}”",
        "login.hint": "You can now switch to it with `switch` — no re-login needed.",
        "sess.adopt_note": "Note: cloud ownership was updated too. If the client is running, it may need a restart to pick up the change.",
        "body.title": "Session body archive",
        "body.dir": "Archive dir",
        "body.blobs": "Body files",
        "body.size": "Size",
        "body.session": "Known sessions",
        "body.withbody": "with body",
        "body.missing_hint": "{n} session(s) have no body on disk; run `bodies --archive` while they are still present.",
        "body.archiving": "Archiving bodies for {n} session(s)…",
        "body.archived": "Done: stored {stored}, deduped {deduped}, missing {missing}, added {size}",
        "body.restored": "Restored body: {path}",
        "body.not_found": "No archived body for session {sid}",
